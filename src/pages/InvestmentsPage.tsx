          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center animate-fade-in">
              <h1 className="font-playfair text-4xl md:text-6xl font-bold text-primary mb-6">
                Curated Real Estate Investments Across Europe
              </h1>
              <p className="text-xl text-foreground/80 leading-relaxed max-w-3xl mx-auto">
                We connect investors with high-performing opportunities in Spain, Austria, and Croatia. Frontier Residences manages every step: acquisition, evaluation, renovation, and turnkey rental operations.
              </p>
            </div>
          </div>
        </section>
