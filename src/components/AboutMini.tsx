 ...
 *
 * A guest choosing between a platform listing and a direct booking is deciding
 * whether there is anyone behind the site. Four names and four faces answer
 * that faster than a paragraph about values, which is why the copy here is one
 * sentence and the rest of the About page stays on the About page.
 *
  ...
  return (
    <section id="about-mini" className="py-24 bg-background scroll-mt-20">
      <div className="container mx-auto px-4">
        <SectionIntro
          idPrefix="am"
          eyebrow="Who looks after your stay"
